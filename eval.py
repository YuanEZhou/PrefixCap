...
# Input paths
parser.add_argument('--model', type=str, default='save/new/ClipCaptionPrefix-TokenLearner-gpt2-clip-vit-large-patch14/model-best.pth',
...
# misc
parser.add_argument('--id', type=str, default='ClipCaptionPrefix-TokenLearner-gpt2-clip-vit-large-patch14', 
...
if len(opt.id) == 0:
    opt.id = infos['opt'].id
ignore = ["id", "batch_size", "beam_size", "start_from", "language_eval", "block_trigrams","max_length"]
